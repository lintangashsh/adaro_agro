                        ...
                        <?php else : ?>
                            ...
                            <li>
                                <button class="flex items-center space-x-3" id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start">
                                    <img class="w-h-12 h-12 rounded-full cursor-pointer" src="<?= base_url('assets/img/profil/') . $user['image'] ?>" alt="#" :class="{'w-12': !scrolledFromTop, 'w-9': scrolledFromTop, 'h-12': !scrolledFromTop, 'h-9': scrolledFromTop}">
