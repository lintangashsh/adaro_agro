...
<div class="w-screen h-screen flex flex-col justify-center items-center">
    ...
    <form method="post" action="<?= base_url('auth') ?>" class="flex flex-col justify-center items-center">
        ...
        <div class="relative mt-8">
            ...
            <input type="password" id="password" name="password" placeholder="Password" class="pl-8 border-b-2 font-montserrat outline-none focus:outline-none focus:border-lime-500 transition-all duration-500 text-lg">
            <!-- Text Error -->
            <small class="text-red-600 font-montserrat duration-300">
                <?= form_error('password') ?>
            </small>
        ...
        <div class="flex flex-row w-full mt-4 justify-center">
            <div class="text-gray-600 font-semibold">Do not have an account? <a href="<?= base_url('auth/registration') ?>" class=" text-gray-600 font-bold"> Register new account here!</a> </div>
        </div>
        <button type="submit" class="py-3 px-20 bg-lime-600 hover:bg-lime-800 rounded-full text-white font-bold uppercase text-lg mt-4 transform hover:translate-y-1 transition-all duration-300">Login</button>
    </form>
