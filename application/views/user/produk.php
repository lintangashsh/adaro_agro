<body class="w-full h-full" id="up">
    <div class="pt-24">
        <div class="relative w-full px-10 lg:px-20 lg:mt-20 mt-10 justify-items-center">
            <h1 class="font-montserrat my-5 lg:mt-20 text-xl lg:text-4xl text-center font-bold text-lime-500">Our Products</h1>
            ...
            <div class="w-full mt-10 lg:bg-gray-50 rounded-xl lg:pl-9 pb-5">
                <div class="lg:text-xl text-lg font-montserrat font-bold mt-16 mb-5">
                    Black Tea Grade I
                </div>
                        ...
                        <div class="max-w-sm bg-white rounded-lg shadow-md" data-aos-delay="<?= $delay; ?>" data-aos="fade-right">
                            ...
                            <div class="px-5 py-5">
                                ...
                                <div class="flex justify-between items-center mt-4 mb-5">
                                    <span class="text-2xl font-bold text-gray-900">USD <?= number_format($pdk->price, 0, ',', '.')  ?>/Kg</span>
