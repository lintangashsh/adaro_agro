            ...
            <div class="w-full h-full m-auto items-center text-center">
                <div class="mt-36 text-center">
                    ...
                    <div class="w-4/12 py-10 rounded-xl m-auto bg-slate-50 bg-opacity-70">
                        ...
                        <h1 class="text-5xl font-bold font-montserrat text-gray-800">Sign Up</h1>
                        ...
                        <form method="post" action="<?= base_url('auth/registration') ?>" class="flex flex-col justify-center items-center mt-10">
                            ...
                            <div>
                                ...
                                <div class="relative mt-6">
                                    ...
                                    <input type="text" name="email" id="email" value="<?= set_value('email'); ?>" class="bg-white border border-white shadow-xl text-gray-900 text-base rounded-full focus:ring-lime-500 focus:border-lime-500 block w-80 h-14 pl-14 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-600 dark:focus:border-green-600" placeholder="Email">
                                </div>
                                <small class="text-red-600 font-semibold font-montserrat text-left duration-300">
                                    <?= form_error('email') ?>
                                </small>
                                ...
                                <div class="relative mt-6">
                                    ...
                                    <input type="password" name="password1" id="password1" class="bg-white border border-white shadow-xl text-gray-900 text-base rounded-full focus:ring-lime-500 focus:border-lime-500 block w-80 h-14 pl-14 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-600 dark:focus:border-green-600" placeholder="Password">
                                </div>
                                <small class="text-red-600 font-semibold font-montserrat text-left duration-300">
                                    <?= form_error('password') ?>
                                </small>
                                ...
                                <div class="relative mt-6">
                                    ...
                                    <input type="password" name="password2" id="password2" class="bg-white border border-white shadow-xl text-gray-900 text-base rounded-full focus:ring-lime-500 focus:border-lime-500 block w-80 h-14 pl-14 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-600 dark:focus:border-green-600" placeholder="Repeat Password">
                                </div>
                                <small class="text-red-600 font-semibold font-montserrat text-left duration-300">
                                    <?= form_error('password') ?>
                                </small>
