            ...
            <?php foreach ($produk as $pdk) : ?>
                ...
                <form class="space-y-6" action="<?= base_url('user/tambah_aksi_testimoni_detail'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex w-full justify-center">
                        <button type="submit" class="lg:w-1/2 w-full right-1/2 text-white bg-lime-700 hover:bg-lime-800 focus:ring-4 focus:outline-none focus:ring-lime-300 font-medium rounded-lg text-lg lg:text-base px-5 py-2.5 ml-1 text-center dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800">Submit Review</button>
                    </div>
                </form>
